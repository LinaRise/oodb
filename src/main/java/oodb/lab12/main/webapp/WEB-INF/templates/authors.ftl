...
<H2>
    ...
    <div>
        (шаблон страницы - authors.ftl, контроллер - ru.icmit.oodb.lab12.controller.AuthorController)
    </div>
	...
	<table>
		...
		<tr>
			...
			<td><#if author.lastname??><a href='${model["app_path"]}/addauthor?id=${author.id}'>${author.lastname}</a></#if></td>
