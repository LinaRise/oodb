...
<div class="c-wrapper">
    ...
    <div>
        (шаблон страницы - search.ftl, контроллер - ru.icmit.oodb.lab12.controller.SearchController)
    </div>

    <h3>
        <a href='${model["app_path"]}/addauthor'>Новый автор</a><br/>
    </h3>
    ...
    <h3>
        <a href='${model["app_path"]}/addsection'>Новая секция</a><br/>
    </h3>
